module.exports = {
    siteUrl: `https://condescending-khorana-e99157.netlify.com`, // Site domain. Do not include a trailing slash!

    postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    siteTitleMeta: `Instability Anna`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `I-Anna`, // Used for App manifest e.g. Mobile Home Screen
